...
class RPIPLC {
	constructor(versionName, modelName, restart_peripherals = false) {
		...
		if (versionName === "RPIPLC_V6") {
			allModels = require("./models-v6");
		}
			...
			throw new UnknownPLCConf(`Unknown version ${versionName}, the only available versions are RPIPLC_V6, RPIPLC_V4 and RPIPLC_V3`)
		}
